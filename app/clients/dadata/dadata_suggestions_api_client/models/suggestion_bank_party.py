...
if TYPE_CHECKING:
    from ..models.bank_party import BankParty


T = TypeVar("T", bound="SuggestionBankParty")
...
class SuggestionBankParty:
    """
    Attributes:
        data (BankParty | Unset):
        unrestricted_value (None | str | Unset):
        value (None | str | Unset):
    """

    data: BankParty | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = BankParty.from_dict(_data)
        ...
        suggestion_bank_party = cls(
            data=data,
            unrestricted_value=unrestricted_value,
            value=value,
        )

        suggestion_bank_party.additional_properties = d
        return suggestion_bank_party
