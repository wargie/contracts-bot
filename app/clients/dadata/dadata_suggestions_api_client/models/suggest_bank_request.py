...
from ..models.suggest_bank_request_status_type_0_item import SuggestBankRequestStatusType0Item
from ..models.suggest_bank_request_type_type_0_item import SuggestBankRequestTypeType0Item
...
class SuggestBankRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> list[SuggestBankRequestStatusType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_type_(data: object) -> list[SuggestBankRequestTypeType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
