...
from ..models.founder_legal_party_type import FounderLegalPartyType
...
T = TypeVar("T", bound="FounderLegalParty")
...
class FounderLegalParty:
    ...
    Attributes:
        ...
        type_ (FounderLegalPartyType | Unset):
    """
    ...
    type_: FounderLegalPartyType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = FounderLegalPartyType(_type_)

        founder_legal_party = cls(
            hid=hid,
            inn=inn,
        ...
        founder_legal_party.additional_properties = d
        return founder_legal_party
