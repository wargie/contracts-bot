...
if TYPE_CHECKING:
    from ..models.suggestion_object import SuggestionObject


T = TypeVar("T", bound="SuggestResponseObject")
...
class SuggestResponseObject:
    """
    Attributes:
        suggestions (list[SuggestionObject] | None | Unset):
    """

    suggestions: list[SuggestionObject] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_suggestions(data: object) -> list[SuggestionObject] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for suggestions_type_0_item_data in _suggestions_type_0:
                    suggestions_type_0_item = SuggestionObject.from_dict(suggestions_type_0_item_data)
                ...
                pass
            return cast(list[SuggestionObject] | None | Unset, data)

        suggestions = _parse_suggestions(d.pop("suggestions", UNSET))

        suggest_response_object = cls(
            suggestions=suggestions,
        )

        suggest_response_object.additional_properties = d
        return suggest_response_object
