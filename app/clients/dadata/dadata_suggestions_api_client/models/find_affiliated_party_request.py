...
from ..models.find_affiliated_party_request_scope_type_0_item import FindAffiliatedPartyRequestScopeType0Item
...
class FindAffiliatedPartyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_scope(data: object) -> list[FindAffiliatedPartyRequestScopeType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
