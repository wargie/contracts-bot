...
from ..models.suggest_party_request_branch_type_type_0_item import SuggestPartyRequestBranchTypeType0Item
from ..models.suggest_party_request_status_type_0_item import SuggestPartyRequestStatusType0Item
...
class SuggestPartyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branch_type(data: object) -> list[SuggestPartyRequestBranchTypeType0Item] | None | Unset:
            if data is None:
                return data
        ...
        def _parse_status(data: object) -> list[SuggestPartyRequestStatusType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
