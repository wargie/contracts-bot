...
if TYPE_CHECKING:
    from ..models.suggestion_bank_party import SuggestionBankParty


T = TypeVar("T", bound="SuggestResponseBankParty")
...
class SuggestResponseBankParty:
    """
    Attributes:
        suggestions (list[SuggestionBankParty] | None | Unset):
    """

    suggestions: list[SuggestionBankParty] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_suggestions(data: object) -> list[SuggestionBankParty] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for suggestions_type_0_item_data in _suggestions_type_0:
                    suggestions_type_0_item = SuggestionBankParty.from_dict(suggestions_type_0_item_data)
                ...
                pass
            return cast(list[SuggestionBankParty] | None | Unset, data)

        suggestions = _parse_suggestions(d.pop("suggestions", UNSET))

        suggest_response_bank_party = cls(
            suggestions=suggestions,
        )

        suggest_response_bank_party.additional_properties = d
        return suggest_response_bank_party
