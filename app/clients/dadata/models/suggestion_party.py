...
if TYPE_CHECKING:
    from ..models.individual_party import IndividualParty
    from ..models.legal_party import LegalParty


T = TypeVar("T", bound="SuggestionParty")
...
class SuggestionParty:
    """
    Attributes:
        data (IndividualParty | LegalParty | Unset):
        unrestricted_value (None | str | Unset):
        value (None | str | Unset):
    """

    data: IndividualParty | LegalParty | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, LegalParty):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> IndividualParty | LegalParty | Unset:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = LegalParty.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            data_type_1 = IndividualParty.from_dict(data)
        ...
        suggestion_party = cls(
            data=data,
            unrestricted_value=unrestricted_value,
            value=value,
        )

        suggestion_party.additional_properties = d
        return suggestion_party
