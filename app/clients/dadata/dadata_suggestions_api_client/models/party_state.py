...
from ..models.party_state_status import PartyStateStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="PartyState")
...
class PartyState:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = PartyStateStatus(d.pop("status"))
        ...
        party_state.additional_properties = d
        return party_state
