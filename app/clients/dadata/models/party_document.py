...
from ..models.party_document_type import PartyDocumentType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PartyDocument")
...
class PartyDocument:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = PartyDocumentType(d.pop("type"))
        ...
        party_document.additional_properties = d
