...
T = TypeVar("T", bound="SuggestionPhone")
...
class SuggestionPhone:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggestion_phone = cls(
            data=data,
            unrestricted_value=unrestricted_value,
            value=value,
        )

        suggestion_phone.additional_properties = d
        return suggestion_phone
