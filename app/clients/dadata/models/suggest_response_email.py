...
T = TypeVar("T", bound="SuggestResponseEmail")
...
class SuggestResponseEmail:
    """
    Attributes:
        suggestions (list[SuggestionEmail] | None | Unset):
    """

    suggestions: list[SuggestionEmail] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_suggestions(data: object) -> list[SuggestionEmail] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for suggestions_type_0_item_data in _suggestions_type_0:
                    suggestions_type_0_item = SuggestionEmail.from_dict(suggestions_type_0_item_data)
        ...
        suggest_response_email = cls(
            suggestions=suggestions,
        )

        suggest_response_email.additional_properties = d
        return suggest_response_email
