...
from ..models.find_party_by_id_request_branch_type_type_0_item import (
    FindPartyByIdRequestBranchTypeType0Item,
)
from ..models.find_party_by_id_request_status_type_0_item import (
...
class FindPartyByIdRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branch_type(
            data: object,
        ) -> list[FindPartyByIdRequestBranchTypeType0Item] | None | Unset:
            if data is None:
                return data
        ...
        def _parse_status(
            data: object,
        ) -> list[FindPartyByIdRequestStatusType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
