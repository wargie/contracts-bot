...
if TYPE_CHECKING:
    from ..models.company_with_email import CompanyWithEmail


T = TypeVar("T", bound="SuggestionCompanyWithEmail")
...
class SuggestionCompanyWithEmail:
    """
    Attributes:
        data (CompanyWithEmail | Unset):
        unrestricted_value (None | str | Unset):
        value (None | str | Unset):
    """

    data: CompanyWithEmail | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CompanyWithEmail.from_dict(_data)
        ...
        suggestion_company_with_email = cls(
            data=data,
            unrestricted_value=unrestricted_value,
            value=value,
        )

        suggestion_company_with_email.additional_properties = d
        return suggestion_company_with_email
