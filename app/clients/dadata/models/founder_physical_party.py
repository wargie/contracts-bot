...
from ..models.founder_physical_party_type import FounderPhysicalPartyType
...
T = TypeVar("T", bound="FounderPhysicalParty")
...
class FounderPhysicalParty:
    ...
    Attributes:
        ...
        type_ (FounderPhysicalPartyType | Unset):
    """
    ...
    type_: FounderPhysicalPartyType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_share(
            data: object,
        ) -> DecimalFounderShare | FractionFounderShare | Unset:
            if isinstance(data, Unset):
                return data
            try:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = FounderPhysicalPartyType(_type_)

        founder_physical_party = cls(
            fio=fio,
            hid=hid,
            inn=inn,
        ...
        founder_physical_party.additional_properties = d
        return founder_physical_party
