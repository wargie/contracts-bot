...
T = TypeVar("T", bound="SuggestResponseAddress")
...
class SuggestResponseAddress:
    """
    Attributes:
        suggestions (list[SuggestionAddress] | None | Unset):
    """

    suggestions: list[SuggestionAddress] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_suggestions(data: object) -> list[SuggestionAddress] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for suggestions_type_0_item_data in _suggestions_type_0:
                    suggestions_type_0_item = SuggestionAddress.from_dict(suggestions_type_0_item_data)
                ...
                pass
            return cast(list[SuggestionAddress] | None | Unset, data)

        suggestions = _parse_suggestions(d.pop("suggestions", UNSET))

        suggest_response_address = cls(
            suggestions=suggestions,
        )

        suggest_response_address.additional_properties = d
        return suggest_response_address
