...
if TYPE_CHECKING:
    from ..models.fias_address import FiasAddress


T = TypeVar("T", bound="SuggestionFiasAddress")
...
class SuggestionFiasAddress:
    """
    Attributes:
        data (FiasAddress | Unset):
        unrestricted_value (None | str | Unset):
        value (None | str | Unset):
    """

    data: FiasAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = FiasAddress.from_dict(_data)
        ...
        suggestion_fias_address = cls(
            data=data,
            unrestricted_value=unrestricted_value,
            value=value,
        )

        suggestion_fias_address.additional_properties = d
        return suggestion_fias_address
