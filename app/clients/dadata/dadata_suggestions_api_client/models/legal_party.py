    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_founders(
            ...
            try:
                ...
                pass
            return cast(list[FounderLegalParty | FounderParty | FounderPhysicalParty] | None | Unset, data)
        ...
        def _parse_managers(
            ...
            try:
                ...
                pass
            return cast(list[ManagerLegalParty | ManagerParty | ManagerPhysicalParty] | None | Unset, data)
