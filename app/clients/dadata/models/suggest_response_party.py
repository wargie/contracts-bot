...
if TYPE_CHECKING:
    from ..models.suggestion_party import SuggestionParty


T = TypeVar("T", bound="SuggestResponseParty")
...
class SuggestResponseParty:
    """
    Attributes:
        suggestions (list[SuggestionParty] | None | Unset):
    """

    suggestions: list[SuggestionParty] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_suggestions(data: object) -> list[SuggestionParty] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for suggestions_type_0_item_data in _suggestions_type_0:
                    suggestions_type_0_item = SuggestionParty.from_dict(suggestions_type_0_item_data)
                ...
                pass
            return cast(list[SuggestionParty] | None | Unset, data)

        suggestions = _parse_suggestions(d.pop("suggestions", UNSET))

        suggest_response_party = cls(
            suggestions=suggestions,
        )

        suggest_response_party.additional_properties = d
        return suggest_response_party
